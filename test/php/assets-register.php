 ...
 * Register theme assets
 */
if ( ! function_exists( 'CassidyWP\Banyan\register_theme_assets' ) ) :
	/**
	 * Register theme assets
	 *
	 * @since 1.0.0
...
add_action( 'wp_enqueue_scripts', 'CassidyWP\Banyan\register_theme_assets' );

/**
 * Register editor UI assets
 */
if ( ! function_exists( 'CassidyWP\Banyan\register_editor_ui_assets' ) ) :
	/**
	 * Register editor UI assets
	 *
	 * @since 2.0.7
...
add_action( 'enqueue_block_editor_assets', 'CassidyWP\Banyan\register_editor_ui_assets' );

/**
 * Register theme block pattern categories
 */
if ( ! function_exists( 'CassidyWP\Banyan\register_theme_block_pattern_categories' ) ) :
	/**
	 * Register theme block pattern categories
	 *
	 * @since 1.0.0
...
add_action( 'init', 'CassidyWP\Banyan\register_theme_block_pattern_categories' );
